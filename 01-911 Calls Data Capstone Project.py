...
# ** You should have noticed it was missing some Months, let's sene if
#we can maybe fill in this information by plotting the information in another
#way, possibly a simple line plot that fills in the missing months, in order
#to do this, we'll need to do some work with pandas... **
